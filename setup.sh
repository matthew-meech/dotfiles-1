...
# git clone https://github.com/matthew-meech/dotfiles.git
...
# Configure Git
git config --global user.email "matthew.meech@mths.ca"
git config --global user.name "matthew-meech"
...
ssh-keygen -t ed25519 -C "matthew.meech@mths.ca"
